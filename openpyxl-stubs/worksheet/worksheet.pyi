...
class Worksheet:
    ...
    def _move_cell(self, row: int, column: int, row_offset: int, col_offset: int, translate: bool = ...) -> None: ...
    def _move_cells(
        self,
    ...
    def values(
        self
    ) -> Iterator[Union[Tuple[str, None, None, None, None, None, None], Tuple[None, None, None, None, None, None, None], Tuple[None, None, None, None, None, None, str]]]: ...
